...
const SKINS_DATA = [
    { id: 'default_cloud', name: 'Doma', price: 0, image: 'cloud.png' },
    { id: 'skin1_cloud', name: 'Psycho Doma', price: 200, image: 'cloud_skin1.png' },
    { id: 'skin2_cloud', name: 'Monk Doma', price: 500, image: 'cloud_skin2.png' },
];
...
function savePlayerData() {
    try {
        localStorage.setItem('dodgeDomenPlayerData', JSON.stringify(playerData));
    } catch (e) {
...
function loadPlayerData() {
    try {
        const savedData = localStorage.getItem('dodgeDomenPlayerData');
        if (savedData) {
...
// Удалены все серверные функции - игра теперь работает локально
